  ...
  List<Widget> getPilierSubWidget(String idPilier ){
    switch(idPilier){
      ...
      case "pilier1" :
        return [
          SizedBox(height: 1,),
          EnjeuWidget(numero:"1a",idPilier: widget.idPilier,idEnjeu: "enjeu1a",enjeuTitle: "Gouvernance DD et stratégie",dropDownState: widget.dropDownState,color: widget.color,),
          SizedBox(height: 1,),
          ...
          SizedBox(height: 1,),
          EnjeuWidget(numero:"2",idPilier: widget.idPilier,idEnjeu: "enjeu2",enjeuTitle: "Éthique des affaires et achats responsables",dropDownState: widget.dropDownState,color: widget.color),
          SizedBox(height: 1,),
          EnjeuWidget(numero:"3",idPilier: widget.idPilier,idEnjeu: "enjeu3",enjeuTitle: "Intégration des attentes DD des clients et consommateurs",dropDownState: widget.dropDownState,color: widget.color,),
          SizedBox(height: 1,),
        ];
      case "pilier2" :
        return [
          SizedBox(height: 1,),
          EnjeuWidget(numero:"4",idPilier: widget.idPilier,idEnjeu: "enjeu4",enjeuTitle: "Égalité de traitement",dropDownState: widget.dropDownState,color: widget.color,),
          SizedBox(height: 1,),
          ...
          SizedBox(height: 1,),
          EnjeuWidget(numero:"6",idPilier: widget.idPilier,idEnjeu: "enjeu6",enjeuTitle: "Amélioration du cadre de vie",dropDownState: widget.dropDownState,color: widget.color),
          SizedBox(height: 1,),
        ];
      case "pilier3" :
        return [
          SizedBox(height: 1,),
          EnjeuWidget(numero:"7",idPilier: widget.idPilier,idEnjeu: "enjeu7",enjeuTitle: "Inclusion sociale et développement des communautés",dropDownState: widget.dropDownState,color: widget.color,),
          SizedBox(height: 1,),
        ];
      case "pilier4" :
        return [
          SizedBox(height: 1,),
          EnjeuWidget(numero:"8",idPilier: widget.idPilier,idEnjeu: "enjeu8",enjeuTitle: "Changement climatique et déforestation",dropDownState: widget.dropDownState,color: widget.color),
          SizedBox(height: 1,),
          ...
          SizedBox(height: 1,),
          EnjeuWidget(numero:"10",idPilier: widget.idPilier,idEnjeu: "enjeu10",enjeuTitle: "Gestion des ressources et déchets",dropDownState: widget.dropDownState,color: widget.color,),
          SizedBox(height: 1,),
        ];
      default:
        return [
