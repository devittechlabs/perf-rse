...
class _UserAdminState extends State<UserAdmin> {
                        ...
                        Container(
                          ...
                          child: DataTable2(
                              ...
                              columns: const [
                                ...
                                DataColumn2(label: Text("Filiale"), size: ColumnSize.S),
                                DataColumn(label: Text("Entités")),
                                DataColumn(label: Text("Niveau d'acces")),
  ...
  DataRow userViewModel(UserModel userModel) {
    return DataRow(cells: [
      ...
      DataCell(Text("${userModel.prenom}")),
      DataCell(Text("${userModel.prenom}")),
      DataCell(Text(" Collecteur - Validateur")),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                if(!enableButton) CircularProgressIndicator(),
                ElevatedButton(
                    style: ElevatedButton.styleFrom(
                    ...
                    onPressed: !enableButton? null : () async{
                      ...
                      if (isValidForm && acces != null && entity != null) {
                        //var response = await apiClient.createUserPilotage(data: data);
                        if(true){
                          //await sendMail("${data["name"]} ${data["lastName"]}",data["email"],passwordEmail);
                          Get.back();
