...
import '../_internal/conpoments/mouse_hover_builder.dart';
import '../_internal/conpoments/simple_value_notifier.dart';
import 'styles_modules.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (_, BoxConstraints constraints) {
        ...
        // Handle color
        Color handleColor = widget.handleColor ?? (Get.isDarkMode ? Color(0xff909f9c).withOpacity(.2) : Color(0xff909f9c));
        // Track color
        Color trackColor =
            widget.trackColor ?? (Get.isDarkMode ? Color(0xff909f9c).withOpacity(.1) : Color(0xff909f9c).withOpacity(.3));
